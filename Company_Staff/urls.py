...
# ----------------recurring invoice----------------
    ...
    path('recurring_invoice',views.recurring_invoice,name='recurring_invoice'),
    path('recurring_invoice_create',views.recurring_invoice_create,name='recurring_invoice_create'),
    path('recurringinvoice_customer',views.recurringinvoice_customer,name='recurringinvoice_customer'),
